#streamlit run C:\Users\ayesh\Downloads\Diagnosify-main\🏠Home.py --server.maxUploadSize=1000
...
# Main content
st.markdown("<h1>Welcome to Brainalyze!</h1>", unsafe_allow_html=True)




# Display the image
image_path = "C:/Users/ayesh/Downloads/Diagnosify-main (2)/Diagnosify-main/Diagnosify-main/images/brain chemistry-cuate.png"
...
st.markdown(
    """
Meet the dedicated team behind Brainalyze: Ayesha Siddiqa, Bhavani V, Chandana R, Charmie J Jain. We are passionate about leveraging technology to improve brain health and provide accurate disease predictions.
"""
)

# Display the image
image_path = "C:/Users/ayesh/Downloads/Diagnosify-main (2)/Diagnosify-main/Diagnosify-main/images/Team work-amico.png"
image = Image.open(image_path)
