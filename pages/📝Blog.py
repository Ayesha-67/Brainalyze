...
# Main content
st.title("Welcome to Brainalyze Blog! 🧠📝")


st.write("Here you will find blog pages from the world's largest medical communities. Explore the blogs and acquaint yourself with knowledge ")
